...
void initButtons() {
  ...
  buttonArray[i++] = new RGBActionButton(YX_BUTTON, 4, 2, 6, { 75, 155, 214 }, keys.transposeUp);    // Transpose +
  buttonArray[i++] = new RGBActionButton(YX_BUTTON, 3, 2, 5, {75, 155, 214 }, keys.transposeDown);  // Transpose -
  buttonArray[i++] = new RGBActionButton(YX_BUTTON, 2, 8, 17, { 75, 155, 214 }, channelUp);          // Channel +
