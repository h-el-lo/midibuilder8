...
//   int level;           // Current transpose Level
//   int lUpper, lLower;  // lLower (limit Lower), lUpper (limit Upper).

//   public:
//   // function to handle Transpose::Transpose()
//   Transpose() {
//     level = 0;
//     lUpper = 24;
//     lLower = -24;
...
//   public:
//   Transpose(int initial_transpose_level, int upperLimit, int lowerLimit) {
//     level = initial_transpose_level;
//     lUpper = upperLimit;
//     lLower = lowerLimit;
//   }
...
//   public:
//   // By default, the channel number will be set to "0", with an offset of "0" still.
//   Channel() {
//   }

//   public:
//   Channel(String Offset) {
//     if (Offset.toLowerCase() == "offset") {
//       OFFSET = 1;
//       CHANNEL += OFFSET;
//       lLower += OFFSET;
//       lUpper += OFFSET;
...
//   // A function to return the offset of the channel instance
//   bool offset() {
//     return OFFSET;
//   }
...
//   int level = 0;  // Current transpose Level
//   int lUpper = 24; // lUpper (limit Upper)
//   int lLower = -24; // lLower (limit Lower)
...
// public:
//   CREATE_DEFAULT_TRANSPOSE_INSTANCE() {
//     level = 0;
//     lUpper = 24;
//     lLower = -24;
//   }
...
// printScreen();
// getView() // Different windows
// changeChannel()
// Edit bank(), modify bank settings
// loadBank()
// saveBank()

// struct bank {
//   bank name; String name = "Bank 1";
//   cc settings;
//   transpose settings;
// }
