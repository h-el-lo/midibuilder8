...
GroupButton::GroupButton(ButtonType type,
                         uint8_t anodePin,
                         uint8_t cathodePin,
                         uint8_t index,
                         uint8_t rgbIndex,
...
RGBButton::RGBButton(ButtonType type,
                     uint8_t anodePin,
                     uint8_t cathodePin,
                     uint8_t rgbIndex,
                     RGB* rgb)
  : Button(type, anodePin, cathodePin, false),  // latch
    _rgbIndex(rgbIndex),
    _rgb(rgb) {}

void RGBButton::onPress() {
  _rgb->triggerEffect(_rgbIndex);
}

void RGBButton::onRelease() {
  _rgb->clearEffect(_rgbIndex);
}
...
static GroupButton::GroupMode groupMode = GroupButton::MODE_PRESET;
static GroupButton::Bank      groupBank = GroupButton::BANK_A;
