...
public:
  ...
  bool getMomentary() const { return _momentary; }
...
//  Sends MIDI CC, drives RGB LED
// ─────────────────────────────────────────────
class GroupButton : public Button {
public:
  enum GroupMode {
    MODE_SCENE,   // CC64, momentary
    MODE_PRESET   // CC0/127, latch
  };
...
// ─────────────────────────────────────────────
//  RGB Strip Button
//  Triggers pixel effects on the RGB strip
// ─────────────────────────────────────────────
